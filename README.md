...
**版本**: v1.16.1 | **技术栈**: Node.js + Express + SQLite + 原生 HTML/CSS/JS | **许可**: MIT
...
| 版本 | 日期 | 主要内容 |
|------|------|----------|
| v1.16.1 | 2026-06-10 | 2K/4K屏幕自适应（内容区+统计+设置+监控+Nginx分栏+侧边栏+字体全面升级） |
| v1.16.0 | 2026-06-10 | 白色主题全面重构（黑红金配色+新SVG Logo+1080P优化） |
